...
const Content = () => {
  ...
  const defLabel = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus neque sint id perspiciatis voluptates, incidunt repellat quae tempora molestiae nostrum. Natus saepe praesentium molestias reiciendis totam, aperiam blanditiis distinctio aliquid?"
  ...
  return (
    <div className='py-10'>
        <div className='px-12'>
            <div className='grid grid-cols-4 gap-x-12 pb-8'>
            ...
            <div>
                <ListProduct data={popularProduct} label={defLabel} title='popular' isFilter={false} />
                <ProductOverview />
                {/* <ListProduct data={recommendProduct} label={defLabel} title='rekomendasi' isFilter={false} /> */}
                <ListProduct data={dataJson} label={defLabel} title='List produk' isFilter />
            </div>
        </div>
    </div>
  )
